...
public class TCGlobalLootModifierProvider extends GlobalLootModifierProvider {
    ...
    private void lootTableId(String group, String condition, String table) {
        ...
        LootItemCondition[] conditions = {LootTableIdCondition.builder(Identifier.withDefaultNamespace(modifier)).build()};
        add(modifier, new AddTableLootModifier(conditions, 1000, ResourceKey.create(Registries.LOOT_TABLE, TerraCurio.asResource("with/" + group + "/" + table))));
    }
