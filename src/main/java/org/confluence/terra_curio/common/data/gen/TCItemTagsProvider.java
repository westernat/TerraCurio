...
public class TCItemTagsProvider extends ItemTagsProvider {
    public TCItemTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
        super(output, provider, TerraCurio.MODID);
    }

    @Override
    protected void addTags(HolderLookup.Provider provider) {
        TagAppender<Item, Item> accessory = tag(TCTags.ACCESSORY);
