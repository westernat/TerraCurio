...
public class PanicNecklace extends BaseCurioItem {
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        long lastHurt = nbt.getLongOr(KEY, 0);
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> getAttributeModifiers(SlotContext slotContext, Identifier id, ItemStack stack) {
        ...
        return LibUtils.getOrCreatePersistedData(player).getLongOr(KEY, 0) == 0 ? EMPTY_ATTRIBUTE : super.getAttributeModifiers(slotContext, id, stack);
    }
