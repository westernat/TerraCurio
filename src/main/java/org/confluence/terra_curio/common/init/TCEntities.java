...
public final class TCEntities {
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(Registries.ENTITY_TYPE, TerraCurio.MODID);
    ...
    public static final RegistryObject<EntityType<XBoneProjectile>> X_BONE = ENTITIES.register("x_bone", () -> EntityType.Builder.of(XBoneProjectile::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).build("terra_curio:x_bone"));
}
