...
public final class TCRecipes {
    ...
    public static final Supplier<RecipeSerializer<WorkshopRecipe>> WORKSHOP_SERIALIZER = RECIPE_SERIALIZERS.register("workshop", () -> WorkshopRecipe.SERIALIZER);
    public static final Supplier<RecipeSerializer<ExtraStepStoolRecipe>> EXTRA_STEP_STOOL_SERIALIZER = RECIPE_SERIALIZERS.register("extra_step_stool", () -> ExtraStepStoolRecipe.SERIALIZER);
