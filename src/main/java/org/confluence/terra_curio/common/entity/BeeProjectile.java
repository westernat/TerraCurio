...
public class BeeProjectile extends Projectile {
    ...
    public void tick() {
        ...
        if (!getInBlockState().getFluidState().isEmpty() || blockHitCount > (isGiant() ? 2 : 1) || tickCount > (isGiant() ? 220 : 200)) {
            discard();
        }
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        this.blockHitCount = input.getIntOr("BlockHitCount", 0);
        this.baseDamage = input.getIntOr("BaseDamage", 0);
    }
    ...
    protected void addAdditionalSaveData(ValueOutput output) {
        ...
        output.putInt("BlockHitCount", blockHitCount);
