...
public class TooltipComponentsValue implements PrimitiveValue<List<TooltipComponentsValue.Storage>> {
    ...
    public static Storage create(Identifier texture, Component text) {
    ...
    public static Storage create(Identifier texture, String text) {
    ...
    public record Storage(Identifier texture, Component text) {
        public static final Codec<Storage> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Identifier.CODEC.fieldOf("texture").forGetter(Storage::texture),
