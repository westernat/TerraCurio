...
public record AttributeModifiersValue(ImmutableListMultimap<Holder<Attribute>, AttributeModifier> value) implements PrimitiveValue<ImmutableListMultimap<Holder<Attribute>, AttributeModifier>> {
    ...
    public List<String> getDescription() {
        ...
        for (Map.Entry<Holder<Attribute>, Collection<AttributeModifier>> entry : value.asMap().entrySet()) {
            list.add(entry.getKey().unwrapKey().orElseThrow().identifier().toString());
            for (AttributeModifier modifier : entry.getValue()) {
                list.add("    " + modifier);
            }
        }
    ...
    public static AttributeModifiersValue simple(Holder<Attribute> attribute, Identifier id, double amount, AttributeModifier.Operation operation) {
    ...
    public static class Builder {
        ...
        public Builder add(Holder<Attribute> attribute, Identifier id, double amount, AttributeModifier.Operation operation) {
