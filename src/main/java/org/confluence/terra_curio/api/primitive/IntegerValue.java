...
public record IntegerValue(int value) implements PrimitiveValue<Integer> {
    ...
    public static final CombineRule<Integer, IntegerValue> GET_ABS_MAX = CombineRule.register(IntegerValue::absMax, "get_abs_max");
