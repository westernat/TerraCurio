...
public class StepStool extends BaseCurioItem {
    public static final Component TOOLTIP = Component.translatable("item.terra_curio.step_stool.tooltip");
    ...
    public Component[] getInformation() {
        return new Component[]{
            Component.translatable("item.terra_curio.step_stool.info")
        };
    }
