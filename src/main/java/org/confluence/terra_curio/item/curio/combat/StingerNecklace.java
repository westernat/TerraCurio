    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        if (ATTRIBUTES == null) {
            ATTRIBUTES = ImmutableMultimap.of(
                    ModAttributes.getArmorPass(), new AttributeModifier(PASS_UUID, "Stinger Necklace", ModConfigs.STINGER_NECKLACE_ARMOR_PASS.get(), AttributeModifier.Operation.ADDITION)
            );
        }
        return ATTRIBUTES;
    }
