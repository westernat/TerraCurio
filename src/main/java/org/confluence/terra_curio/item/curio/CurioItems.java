...
import org.confluence.terra_curio.item.curio.construction.*;
import org.confluence.terra_curio.item.curio.datadriven.DataDrivenCurioGenerator;
import org.confluence.terra_curio.item.curio.datadriven.DataDrivenCurioInfo;
import org.confluence.terra_curio.item.curio.expert.*;
import org.confluence.terra_curio.item.curio.fishing.AnglerEarring;
import org.confluence.terra_curio.item.curio.health.BandOfRegeneration;
import org.confluence.terra_curio.item.curio.informational.*;
import org.confluence.terra_curio.item.curio.miscellaneous.FlowerBoots;
