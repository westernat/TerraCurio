...
public interface IFallResistance {
    ...
    static float apply(LivingEntity living, DamageSource damageSource, float amount) {
        ...
        PlayerAbility.of(living).ifPresent(playerAbility -> atomic.set(playerAbility.getFallResistance()));
    ...
    static boolean isInvul(LivingEntity living, DamageSource damageSource) {
        ...
        PlayerAbility.of(living).ifPresent(playerAbility -> atomic.set(playerAbility.getFallResistance() < 0));
        return atomic.get();
    }
