...
public class BundleOfHorseshoeBalloons extends BundleOfBalloons implements IFallResistance {
    ...
    public void appendHoverText(@NotNull ItemStack itemStack, @Nullable Level level, List<Component> list, @NotNull TooltipFlag tooltipFlag) {
        list.add(Component.translatable("item.terra_curio.bundle_of_horseshoe_balloon.tooltip"));
        list.add(Component.translatable("item.terra_curio.bundle_of_horseshoe_balloon.tooltip2"));
    }
}
