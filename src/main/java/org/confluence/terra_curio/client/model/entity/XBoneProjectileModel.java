...
public class XBoneProjectileModel extends EntityModel<XBoneProjectile> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bone2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(14, 3).addBox(-0.995F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
        ...
        bone2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(12, 10).addBox(-0.005F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
        ...
        bone2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(18, 0).addBox(-0.005F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
        ...
        bone2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(6, 15).addBox(-0.005F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
        ...
        bone3.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(14, 3).addBox(-0.995F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(0, 13).addBox(-0.7071F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(0, 13).addBox(-0.4192F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F)), PartPose.offsetAndRotation(0.2071F, -4.5858F, 0.0858F, 0.7854F, 0.0F, 0.0F));

        bone3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(12, 10).addBox(-0.005F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(12, 10).addBox(0.2829F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(6, 10).addBox(-0.2929F, -3.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F)), PartPose.offsetAndRotation(-0.495F, -4.5858F, -0.0858F, -0.7854F, 0.0F, 0.0F));

        bone3.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(18, 0).addBox(-0.005F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(0, 18).addBox(-0.2929F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(18, 0).addBox(0.2829F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F)), PartPose.offsetAndRotation(-0.495F, 4.5858F, 0.0858F, -0.7854F, 0.0F, 0.0F));

        bone3.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(6, 15).addBox(-0.005F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(12, 15).addBox(-0.2929F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F))
                .texOffs(6, 15).addBox(0.2829F, 0.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2929F)), PartPose.offsetAndRotation(-0.495F, 4.5858F, -0.0858F, 0.7854F, 0.0F, 0.0F));
