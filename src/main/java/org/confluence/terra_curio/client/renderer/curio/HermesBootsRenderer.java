...
import org.confluence.terra_curio.client.model.curio.HermesBootsModel;
import top.theillusivec4.curios.api.SlotContext;
import top.theillusivec4.curios.api.client.ICurioRenderer;

public class HermesBootsRenderer implements ICurioRenderer {
    private static final RenderType CUTOUT = RenderType.entityCutout(TerraCurio.asResource("textures/curio/hermes_boots.png"));
