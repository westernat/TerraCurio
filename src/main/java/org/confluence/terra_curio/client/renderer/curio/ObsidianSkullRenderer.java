...
import org.confluence.terra_curio.client.model.curio.ObsidianSkullModel;
...
public class ObsidianSkullRenderer implements ICurioRenderer {
    ...
    public ObsidianSkullRenderer() {
        this.model = new ObsidianSkullModel(Minecraft.getInstance().getEntityModels().bakeLayer(ObsidianSkullModel.LAYER_LOCATION));
    }
