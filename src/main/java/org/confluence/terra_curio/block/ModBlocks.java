package org.confluence.terra_curio.block;
...
public final class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, TerraCurio.MODID);
