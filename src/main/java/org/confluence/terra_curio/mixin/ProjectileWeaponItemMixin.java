...
public abstract class ProjectileWeaponItemMixin {
    ...
    private static ItemStack canAmmoUse(ItemStack instance, int amount, Operation<ItemStack> original, @Local(argsOnly = true, name = "holder") LivingEntity holder) {
        if (!(instance.getItem() instanceof ArrowItem) || TCUtils.magicQuiver$shouldConsume(holder)) {
