package org.confluence.mod.terra_curio.common.entity.projectile;
...
public class BeeProjectile extends AbstractHurtingProjectile {
    ...
    private static final EntityDimensions SMALL =  ModEntities.BEE_PROJECTILE.get().getDimensions().scale(0.5f);
    private static final EntityDimensions GIANT = ModEntities.BEE_PROJECTILE.get().getDimensions();
